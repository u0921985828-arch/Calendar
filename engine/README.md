...
## Cómo funciona
1. **Corpus** (`train.py`): ~20 intenciones (email, informe, limpieza, trámite,
   estudio, mudanza, viaje…), cada una con frases de ejemplo y una receta de
   micro-pasos con estimaciones.
...
## Ampliar
Añade intenciones o frases en el diccionario `INTENTS` de `train.py`. Más frases
por intención = mejor reconocimiento de variantes. Es el camino barato para que
el motor sea más potente sin servidor.
